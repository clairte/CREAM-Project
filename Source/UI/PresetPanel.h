...
public:
    ...
    {
        const auto container = getLocalBounds().reduced(4); //entire bounds of parent reduced by 4 pixels
...
private:
    ...
    void buttonClicked(juce::Button* button) override
    {
        ...
        if (button == &deleteButton)
        {
            ...
            //unsafe function, can prompt dialogue later
            loadPresetList();
        }
    }
    ...
    Service::PresetManager& presetManager; //need ref to preset manager to call its methods
